...
const Header = () => {
  return (
    <header className="bg-white">
        <nav
        className="mx-auto max-w-7xl px-4 py-5 flex justify-between"
        >
...
<Select>
  <SelectTrigger className="w-45 focus-visible:ring-0 focus:ring-0 focus-visible:border-input">
  ...
  <SelectContent>
    <SelectGroup>
      ...
      <SelectItem value="kids-corner">Kids corner</SelectItem>
           ...
           <div
           className="flex items-center gap-x-2 ml-12"
           >
            <Phone />
